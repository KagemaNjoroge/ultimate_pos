...
def setup_tax_groups():
    ...
    tax_groups = [
        ...
        },
        {
            ...
            "tax_rate": 0.0,
            "status": "ACTIVE",
            "description": "Zero-rated supplies are taxable supplies on which the tax rate is 0%. Zero-rated supplies are listed in the Second Schedule to the VAT Act, 2013. Taxpayers who only make zero-rated supplies are not required to register for VAT.",
        },
        {
            "name": "Exempt",
            "tax_rate": 0.0,
            "status": "ACTIVE",
            "description": "Exempt supplies are not taxable supplies and any related input tax is therefore not deductible. Exempt supplies are listed in the First Schedule to the VAT Act 2013. Taxpayers who only make exempt supplies are not required to register for VAT.",
        },
        {
            "name": "Other Rate",
            "tax_rate": 8.0,
            "status": "INACTIVE",
            "description": "This rate applied to certain supplies (petroleum products) prior to 1st July 2023 but was deleted by the Finance Act, 2023.",
        },
    ]
